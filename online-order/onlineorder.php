...
<!-- Added by HTTrack -->
<!-- Mirrored from masalafresno.com/online-order/onlineorder.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Jan 2016 06:40:10 GMT -->
...
"Curry Express Indian Bistro " accepting online order through Phone Calls also. Simlay You need to call and  book your order online 
      ...
      <form class="form-horizontal" style="margin-left:15%" role="form" name="contactform" id="contactform" method="post" action="#">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<textarea name="event_details" rows="6" class="form-control" id="event_details"></textarea>
					</div>
				</div>
      ...
      <div class="row">
        ...
        <div class="col-md-3">
        	...
        	<!--	<a href="../group-dining/groupdining.php" style="color:#FFFFFF">Group Dining</a><br/>-->
        		<a href="onlineorder.php"  style="color:#FFFFFF">Order Online</a><br/>
