...
if(isset($_POST["submit"])){
    ...
    $subject = "Online Catering order Request From Client";
    $subject2 = "Cofirmation For Your Catering Order";
    ...
    $message2 = "Your Catering Order Has Been Received:-" ."\n\n".
...
$me =  "Your Catering Order Has Been Received , Thank you " . $first_name ." ".$last_name."".", We Will Contact You Shortly....!!!";
